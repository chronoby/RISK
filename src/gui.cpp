...
void Gui::draw(unsigned int tex, int width, int height)
{
	...
	ImGui::Begin("interactive instruction");

	ImGui::Text("camera positon: w, a, s, d");
	ImGui::Text("camera direction: mouse");
	ImGui::Text("Hide or show cursor: e");

	ImGui::Text("light position: i, j, k, l, u, o");
	ImGui::Text("light rotation: r");
	ImGui::Text("light scale: n, m");
